...
class TestReferenceFields(unittest.TestCase):
    ...
    def test_ask_fields_article(self, mock_input):
        ...
        expected_result = ('key', {'author': 'Jaska', 'title': 'Lunta sataa', 'journal': 'Lehti', 'year': '2023', 'volume': '2'})
    ...
    def test_ask_fields_book(self, mock_input):
        reference_type = 'book'
        result = ask_fields(reference_type)
        expected_result = ('key', {'author': 'Jaska', 'title': 'Lunta sataa', 'publisher': 'Kirjat', 'year': '2023'})
        self.assertEqual(result, expected_result)
    ...
    def test_ask_fields_inproceedings(self, mock_input):
        ...
        result = ask_fields(reference_type)
        expected_result = ('key', {'author': 'Jaska', 'title': 'Lunta sataa', 'booktitle': 'Otsikko', 'year': '2023'})
        self.assertEqual(result, expected_result)
